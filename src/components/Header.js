      ...
      <nav className="navbar navbar-expand-lg navbar-bg w-100">
        <div className="container-fluid">
          <div className="d-flex align-items-center">
            <a className="navbar-brand" href="/Sidebar">
            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
              <ul className="navbar-nav topbar">
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="/Sidebar"><i className="fas fa-home icon-color"></i></a>
                </li>
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu">
                    <li><a className="dropdown-item" href='/ebiz'>
                      <div className='d-flex align-items-center'>
